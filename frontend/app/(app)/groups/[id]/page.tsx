          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setEditingLesson((prev: Lesson | null) => prev ? {...prev, title: e.target.value} : null)}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setEditingLesson((prev: Lesson | null) => prev ? {...prev, date: e.target.value} : null)}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setEditingLesson((prev: Lesson | null) => prev ? {...prev, description: e.target.value} : null)}
              />
            </div>
            <div className="flex gap-2">
              <Button
