...
async def main():
    ...
    try:
        ...
        # Admin notification - ko'plab admin ID lar
        ...
        logger.info(f"📢 Adminlarga notifikatsiya: {success_count}/{len(ADMIN_IDS)} ta adminga yuborildi")
